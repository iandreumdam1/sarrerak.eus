...
<?php
    ...
    try {
        ...
        while($fila=mysqli_fetch_array($resultados)){
            ...
            $mail->Subject = 'Cambio de contraseña SARRERAK.EUS.';
            $mail->Body  = "<h1>Información sobre el cambio de contraseña.</h1>
                            Estimado/a Sr./Sra. ".$fila['apellido1']." ".$fila['apellido2'].":
                            <br>Le informamos de que su contraseña de SARRERAK.EUS ha sido cambiada.
                            Hemos recibido su solicitud de cambio de contraseña. Puede iniciar sesión a traves de nuestra <a href='http://www.ibaiandreu.es'>web</a> 
                            o pulsando en el siguinete <a href='https://pruebas.grupoaxium.com/sarrerak.eus/es/iniciar_sesion.php'>enlace</a>.
                            <br>
                            <strong>¡IMPORTANTE¡
                            <br>Si usted no ha cambiado la contraseña pongase en contacto con nosotros lo antes posible.<br></strong>
