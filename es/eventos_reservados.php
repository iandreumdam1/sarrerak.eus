...
<script>
    function redirigir(id){      
      ...
      window.location.href = "entradas_reservadas.php" + "?w1=" + id; 
    }
  </script>
          ...
          <div class="col-lg-12 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            ...
            <p class="font-italic">
              ...
              <?php
                ...
                $consulta="SELECT count(id_entrada) AS contador_entradas, id_evento, eventos.nombre, eventos.descripcion_breve, eventos.fecha_evento
                FROM eventos_inscripcion
                INNER JOIN eventos ON eventos_inscripcion.id_evento = eventos.id
                WHERE id_usuario = '".$_SESSION['nombre_usuario_id']."' AND fecha_evento > '$DateTime' 
                GROUP BY id_evento, eventos.nombre, eventos.descripcion_breve, eventos.fecha_evento ORDER BY fecha_evento ASC ";
                ...
                if($resultados==false){
                  ...
                  while($fila=mysqli_fetch_array($resultados)){
                    echo "<tr style='height: 250px'>
                          <td class='col-4'><img src='ver_imagen.php?id=".$fila['id_evento']."' alt='Imagen del evento.'></img></td>
                          <td class='col-8'>
                            <br><strong>" . $fila['nombre'] . "</strong><br>
                            <br>". $fila['descripcion_breve'] ."
                            <br>". $fila['fecha_evento'] ."
                            <br>
                            <br>Entradas reservadas: ". $fila['contador_entradas'] ."
                            <br>
                            <button style='background-color: #000000; color: #ffffff; margin-top: 20px;' onclick='redirigir(" . $fila['id_evento'] . ")'>Ver entradas</button>
                            <hr>
                          </td>
