    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Iniciar <span>.</span> Sesión</h1>
        </div>
      </div>
               ...
               <div >
                  <div class="form-row">
                    <div class="form-group">
                      <input type="user" class="form-control" name="login" id="usuario" placeholder="Usuario" data-rule="user" data-msg="Ponga un usuario válido" />
                      <div class="validate"></div>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group">
                      <input type="password" class="form-control" name="password" id="password" placeholder="Contraseña" data-rule="minlen:4" data-msg="Rellene este campo" />
                      <div class="validate"></div>
                    </div>
                  </div>
              </div>
